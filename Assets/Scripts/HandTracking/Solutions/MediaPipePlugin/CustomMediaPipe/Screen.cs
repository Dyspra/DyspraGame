...
namespace Mediapipe.Unity.Dyspra // todo: move it to My custom mediapipe folder
{
  public class Screen : MonoBehaviour
  {
    [SerializeField] private RawImage _screen;

    private MyImageSource _imageSource;
    ...
    public void Initialize(MyImageSource imageSource)
    {
    ...
    public void ReadSync(MyTextureFrame textureFrame)
    {
